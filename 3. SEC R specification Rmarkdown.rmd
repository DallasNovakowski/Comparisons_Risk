...
VarBase$R <- c('DsrA_3', 'DsrA_8', 'DsrA_14', 'SOEPg', 'SOEPdri', 'SOEPocc', 'SOEPfin', 'SOEPrec', 'SOEPhea', 'SOEPsoc', 'SSexp', 'SSdis', 'SSas', 'SSbor', 'BISa', 'BISm', 'BISn', 'Dhea', 'Dinv', 'Dgam', 'Deth', 'Drec', 'Dsoc', 'Dm', 'GBS', 'DAST', 'FTND', 'AUDIT', 'NODS')
...
R_corr <- hetcor(residuals_std2[,c(VarBase$R)], std.err=F, ML=TRUE)
all_corr <- hetcor(residuals_std2, use = "complete.obs")
